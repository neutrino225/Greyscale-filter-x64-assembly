...
// bool isGoodEnough(unsigned char* native, unsigned char *greyscale, int width, int height, int threshold){
//     int totalPixels = width * height;
//     int index = 0;

//     while (index < totalPixels)
//     {
//         if((greyscale[index] > native[index] + threshold) || (greyscale[index] < native[index] - threshold)){
//             return false;
//         }
//         index++;
//     }
